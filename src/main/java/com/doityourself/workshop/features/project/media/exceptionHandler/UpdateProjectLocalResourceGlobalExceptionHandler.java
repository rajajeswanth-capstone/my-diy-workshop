...
/**
 * Update Project Local Resource Global Exception Handler
 */
@Slf4j
@Component
public class UpdateProjectLocalResourceGlobalExceptionHandler implements ICommandExceptionHandler<CommandDTO> {
  ...
  private void handle() {
    ...
    exception.setMessages(Collections.singletonList(projectUpdateLocalResourceFailedErrorMessage));
    throw exception;
  }
}
