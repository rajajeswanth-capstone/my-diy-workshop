...
/**
 * Update Project Web Resource Global Exception Handler
 */
@Slf4j
@Component
public class UpdateProjectWebResourceGlobalExceptionHandler implements ICommandExceptionHandler<CommandDTO> {
  ...
  private void handle() {
    ...
    exception.setMessages(Collections.singletonList(projectUpdateWebResourceFailedErrorMessage));
    throw exception;
  }
}
