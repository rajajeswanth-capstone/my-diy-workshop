 ...
 */
@Component
public class GetProjectMaterialsPrintResponseCommand implements ICommand<CommandDTO> {
  @Autowired
  ...
  public void process(CommandDTO dto) {
    ...
    ProjectDetailRepresentation projectDetail = ProjectDetailRepresentation.builder()
        ...
        .materialsByVendors(projectMaterialServiceHelper.groupMaterialsByVendors(materialRepresentations))
        .build();
