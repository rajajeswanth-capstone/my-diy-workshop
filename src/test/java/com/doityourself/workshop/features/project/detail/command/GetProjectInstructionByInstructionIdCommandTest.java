...
public class GetProjectInstructionByInstructionIdCommandTest {
  @Test
  public void testProcess() {
    ...
    GetProjectInstructionByInstructionIdCommand command = new GetProjectInstructionByInstructionIdCommand();
