...
public class GetProjectMaterialsPrintResponseCommandTest {
  @Test
  public void testProcess() {
    ...
    GetProjectMaterialsPrintResponseCommand command = new GetProjectMaterialsPrintResponseCommand();
    ...
    Mockito.when(mockProjectMaterialServiceHelper.groupMaterialsByVendors(projectDetailMaterialRepresentations)).thenReturn(responseMaterialsByVendor);
    ...
    Mockito.verify(mockProjectMaterialServiceHelper, Mockito.times(1)).groupMaterialsByVendors(projectDetailMaterialRepresentations);
    ...
    assert projectDetailRepresentation.getMaterialsByVendors().get("Other") == projectDetailMaterialRepresentations;
  }
}
